...
@section('content')
        ...
        <!-- Begin:: About Section -->
        <section class="commonSection aboutSection3">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 clearfix">
                        <div class="aboutImg float-right clearfix">
                            ...
                            <div class="abImg float-right">
                                <img src="makeover/images/about/2.png" alt="Makeover"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-5 offset-lg-1">
                        <div class="abContent">
                            <h2>
                                Beauty and <span class="fontWeight400 colorPrimary">Spa Center</span>
                            </h2>
                            <p class="leads">
                            ...
                            <img src="makeover/images/about/1.png" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="commonSection historySection">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <div class="abHistory">
                            <h2>1985</h2>
                            <img src="makeover/images/about/3.png" alt="Makeover"/>
                            <p>In the tumultuous business of cutting-in and atten-ding to a whale, there is much running backwards and forwards among the crew.</p>
                        </div>
                    </div>
                    <div class="col-md-4 clearfix">
                        <div class="abHistory">
        ...
        <div class="commonSection featureSection2 hasBeforeDecoration hasAfterDecoration">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="sectionTitle text-center">
                            <img src="makeover/images/icons/4.png" alt=""/>
                            <h5 class="primaryFont">Welcome</h5>
                            <h2>Our <span class="colorPrimary fontWeight400">Feature</span></h2>
                            <p>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="featureImg">
                            <img src="makeover/images/about/4.png" alt=""/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="icon_box_02">
                            ...
                            <h3>Matt Effects</h3>
                            <p>Vivamus nec ligula et leo sodales pellentesque id sed lectus. Aliquam viverra velit sagittis pharetra venenatis</p>
                        </div>
                        <div class="icon_box_02 fib_02">
                            <div class="ib_box">
                                ...
                                <div class="bg_icon"><i class="mkov-Yoga"></i></div>
                                <i class="mkov-Yoga"></i>
                            </div>
                            <h3>Relax Zones</h3>
                            <p>Vivamus nec ligula et leo sodales pellentesque id sed lectus. Aliquam viverra velit sagittis pharetra venenatis</p>
        ...
        <!-- Begin:: Team Section -->
        <section class="commonSection teamSection tm2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="sectionTitle text-center">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team_01 text-center">
                            <div class="tm_thumb">
                                <img src="makeover/images/home_02/t1.jpg" alt=""/>
                                <div class="tm_social">
                            ...
                            <p>Founder</p>
                            <h3><a href="single-team.html">Catherine</a></h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team_01 text-center">
                            <div class="tm_thumb">
                                <img src="makeover/images/home_02/t2.jpg" alt=""/>
                                <div class="tm_social">
                                    <a href="https://www.facebook.com/"><i class="icofont-facebook"></i></a>
                                    <a href="https://envato.com/"><i class="icofont-envato"></i></a>
                                    <a href="https://twitter.com/"><i class="icofont-twitter"></i></a>
                            ...
                            <p>Ceo</p>
                            <h3><a href="single-team.html">Emma Alice</a></h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team_01 text-center">
                            <div class="tm_thumb">
                                <img src="makeover/images/home_02/t3.jpg" alt=""/>
                                <div class="tm_social">
                                    <a href="https://www.facebook.com/"><i class="icofont-facebook"></i></a>
                                    <a href="https://envato.com/"><i class="icofont-envato"></i></a>
                                    <a href="https://twitter.com/"><i class="icofont-twitter"></i></a>
                            ...
                            <h3><a href="single-team.html">Mary Elizabeth</a></h3>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team_01 text-center">
                            <div class="tm_thumb">
                                <img src="makeover/images/home_02/t4.jpg" alt=""/>
                                <div class="tm_social">
                                    <a href="https://www.facebook.com/"><i class="icofont-facebook"></i></a>
                                    <a href="https://envato.com/"><i class="icofont-envato"></i></a>
                                    <a href="https://twitter.com/"><i class="icofont-twitter"></i></a>
                            ...
                            <p>Co-Founder</p>
                            <h3><a href="single-team.html">Margaret</a></h3>
                        </div>
                    </div>
                </div>
            </div>
